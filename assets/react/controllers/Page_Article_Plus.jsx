      ...
      <div className="flex flex-col md:flex-row h-screen">
        ...
        <aside className="w-full md:w-2/12 bg-custom-black p-4 shadow-xl md:shadow-none">
          <ul>
            ...
            <li>
              <a class="flex items-center px-4 py-2 mt-5 hover:text-black rounded-md hover:bg-custom-red" href="ArticleGraph">
            ...
            <li>
              <a class="flex items-center px-4 py-2 mt-5 hover:text-black rounded-md hover:bg-custom-red" href="#">
            ...
            <li>
              <a class="flex items-center px-4 py-2 mt-5 hover:text-black rounded-md hover:bg-custom-red" href="Change-theme">
              <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 12.25V1m0 11.25a2.25 2.25 0 0 0 0 4.5m0-4.5a2.25 2.25 0 0 1 0 4.5M4 19v-2.25m6-13.5V1m0 2.25a2.25 2.25 0 0 0 0 4.5m0-4.5a2.25 2.25 0 0 1 0 4.5M10 19V7.75m6 4.5V1m0 11.25a2.25 2.25 0 1 0 0 4.5 2.25 2.25 0 0 0 0-4.5ZM16 19v-2"/>
              </svg>

                <span class="mx-4 font-medium dark:text-white">Theme</span>
              </a>
            </li>


            <li>
              <a class="flex items-center px-4 py-2 mt-5 hover:text-black rounded-md hover:bg-custom-red" href="contact">
              
              <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                  <path d="m17.418 3.623-.018-.008a6.713 6.713 0 0 0-2.4-.569V2h1a1 1 0 1 0 0-2h-2a1 1 0 0 0-1 1v2H9.89A6.977 6.977 0 0 1 12 8v5h-2V8A5 5 0 1 0 0 8v6a1 1 0 0 0 1 1h8v4a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1v-4h6a1 1 0 0 0 1-1V8a5 5 0 0 0-2.582-4.377ZM6 12H4a1 1 0 0 1 0-2h2a1 1 0 0 1 0 2Z"/>
              </svg>
                <span class="mx-4 font-medium dark:text-white">Contact</span>
              </a>
            </li>
