...
<ul>
  ...
  <li>
    <a className="flex items-center px-4 py-2 mt-5  rounded-md " href="ArticleGraph">
  ...
  <li>
    <a className="flex items-center px-4 py-2 mt-5  rounded-md " href="#">
  ...
  <li>
    <a className="flex items-center px-4 py-2 mt-5  rounded-md " href="ajout_media">
  ...
  <li>
    <a className="flex items-center px-4 py-2 mt-5  rounded-md " href="list-theme">
  ...
  <li>
    <a className="flex items-center px-4 py-2 mt-5  rounded-md " href="contact">
